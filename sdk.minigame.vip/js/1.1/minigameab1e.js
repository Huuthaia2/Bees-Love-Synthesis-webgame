		...
		showAsync() {
			return c(this, void 0, void 0, function*() {
				...
				try {
                    ...
                    console.log("Play Success: " + this.getInfo()), this._adInstance = null, this._state = a.NONE, this.updateLastShowTime(), this._autoLoadOnPlay && (console.log("Reload after 1 seconds: " + this.getInfo()), this.safeReLoadAsync(1)), !0
				} catch (e) {
